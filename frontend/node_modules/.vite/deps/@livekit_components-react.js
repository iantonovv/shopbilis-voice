...
// node_modules/@livekit/components-react/dist/hooks-DEsFub3E.mjs
...
var tr = function(e3) {
  return e3 === void 0 && (e3 = {}), {
    ...
    async fn(t) {
      ...
      const C = [a, ...g], $2 = await Qt(t, b2), I2 = [];
      let z3 = ((r2 = o.flip) == null ? void 0 : r2.overflows) || [];
      if (l && I2.push($2[v]), f) {
        const K2 = Kn(i2, s, P);
        I2.push($2[K2[0]], $2[K2[1]]);
      }
      if (z3 = [...z3, {
        placement: i2,
        overflows: I2
        ...
        let xe2 = (L3 = z3.filter((fe2) => fe2.overflows[0] <= 0).sort((fe2, te2) => fe2.overflows[1] - te2.overflows[1])[0]) == null ? void 0 : L3.placement;
        if (!xe2)
          switch (d) {
            case "bestFit": {
              var oe2;
              const fe2 = (oe2 = z3.filter((te2) => {
                if (S) {
...
function xs(e3, t) {
  ...
  if (h) {
    e3.registerTextStreamHandler(l, (S, C) => V(this, null, function* () {
      const { id: $2, timestamp: I2 } = S.info;
      Ge(S).pipe(
        ct((T2, L3) => T2 + L3),
        A((T2) => ({
          id: $2,
  ...
  const b2 = m.pipe(
    ct((g, S) => {
      if ("id" in S && g.find((C) => {
        var $2, I2;
        return (($2 = C.from) == null ? void 0 : $2.identity) === ((I2 = S.from) == null ? void 0 : I2.identity) && C.id === S.id;
      })) {
        const C = g.findIndex(($2) => $2.id === S.id);
        if (C > -1) {
          const $2 = g[C];
          g[C] = Ee(Z({}, S), {
    ...
    try {
      ...
      return yield Mn(e3.localParticipant, z3, {
        reliable: true,
        topic: f
      }), I2;
    } finally {
...
function $e2(e3, n) {
  ...
  }, [e3.current, t, a]), t == null ? void 0 : t.observer;
}
function Ge2() {
  let e3 = false, n = [];
  ...
  const a = new ResizeObserver((s, c) => {
    n = n.concat(s), e3 || window.requestAnimationFrame(() => {
      ...
      for (let u = 0; u < n.length; u++) {
        ...
        o.add(n[u].target);
        const i2 = t.get(n[u].target);
        i2 == null || i2.forEach((d) => d(n[u], c));
      }
      n = [], e3 = false;
    }), e3 = true;
  });
...
function St(e3) {
  const n = (c) => typeof window < "u" ? window.matchMedia(c).matches : false, [t, a] = r.useState(n(e3));
  function s() {
    a(n(e3));
  }
  return r.useEffect(() => {
...
function vt2(e3) {
  const n = zs(e3), t = r.useCallback(async () => {
    await n.startAudio();
  }, [n]), a = r.useMemo(
    () => co(n),
    [n]
...
function ht2(e3) {
  const { state: n, dispatch: t } = $s().pin;
...
function Mt2(e3 = {}) {
  const n = Vs(e3.participant), { className: t, connectionQualityObserver: a } = r.useMemo(
    () => bs(n),
    [n]
...
function O2(e3) {
  const n = zs(e3), t = r.useMemo(() => ts(n), [n]);
  return b(t, n.state);
}
function yt2(e3, n) {
  const t = typeof e3 == "function" ? e3 : n, a = typeof e3 == "string" ? e3 : void 0, s = Hs(), { send: c, messageObservable: o, isSendingObservable: u } = r.useMemo(
    () => bo(s, a, t),
    [s, a, t]
...
function Pt2(e3) {
  const n = Hs(), t = O2(n);
  return { buttonProps: r.useMemo(() => {
    const { className: s, disconnect: c } = ms(n);
    return M2(e3, {
      className: s,
...
function kt2({ trackRef: e3, props: n }) {
  const t = Ws(e3), a = Lo(), { className: s } = r.useMemo(() => Cs(), []), c = r.useMemo(() => No(t, a == null ? void 0 : a.pin.state), [t, a == null ? void 0 : a.pin.state]);
  return { mergedProps: r.useMemo(
    () => M2(n, {
      className: s,
      onClick: (u) => {
        var i2, d, l, f, p;
        (i2 = n.onClick) == null || i2.call(n, u), c ? (l = a == null ? void 0 : (d = a.pin).dispatch) == null || l.call(d, {
          msg: "clear_pin"
...
function Et(e3, n, t = {}) {
  const a = t.gridLayouts ?? Yo, { width: s, height: c } = je2(e3), o = qi(a, n, s, c);
  return r.useEffect(() => {
...
function z(e3, n = {}) {
  var u, i2;
  const t = typeof e3 == "string" ? n.participant : e3.participant, a = Vs(t), s = typeof e3 == "string" ? { participant: a, source: e3 } : e3, [c, o] = r.useState(
...
function Ye2(e3) {
  const n = Vs(e3), t = r.useMemo(() => as(n), [n]);
  return b(t, n.isSpeaking);
}
function Ze2(e3 = {}) {
  const n = zs(e3.room), [t, a] = r.useState(n.localParticipant), [s, c] = r.useState(
  ...
  return r.useEffect(() => {
    const h = In(n.localParticipant).subscribe(P);
...
function wt2({
  ...
  const c = Io(), o = r.useMemo(() => n ?? c ?? new Room(), [n, c]), u = r.useMemo(
    () => is(e3, s, a),
    [e3, a, s]
  ), i2 = b(u, []), [d, l] = r.useState(
  ...
  return r.useEffect(() => {
    const S = p.subscribe((m) => {
      m && (_2.info("setCurrentDeviceId", m), l(m));
    });
    return () => {
      S == null || S.unsubscribe();
    };
  }, [p]), { devices: i2, className: f, activeDeviceId: d, setActiveMediaDevice: g };
}
function At2({
  kind: e3,
  onError: n
...
function Ke2(e3, n, t = {}) {
  const a = r.useRef([]), s = r.useRef(-1), c = n !== s.current, o = typeof t.customSortFunction == "function" ? t.customSortFunction(e3) : Jo(e3);
  let u = [...o];
  if (c === false)
    try {
      u = Zo(a.current, o, n);
...
function Ct2(e3, n) {
  const [t, a] = r.useState(1), s = Math.max(Math.ceil(n.length / e3), 1);
  t > s && a(s);
  const c = t * e3, o = c - e3, u = (f) => {
    a((p) => f === "next" ? p === s ? p : p + 1 : p === 1 ? p : p - 1);
  }, i2 = (f) => {
    f > s ? a(s) : f < 1 ? a(1) : a(f);
  }, l = Ke2(n, e3).slice(o, c);
  return {
    totalPageCount: s,
    nextPage: () => u("next"),
    prevPage: () => u("previous"),
...
function Ot2(e3 = {}) {
  ...
  const t = r.useMemo(() => fo(n), [n]), { identity: a, name: s, metadata: c } = b(t, {
...
function It2(e3 = {}) {
  const n = Vs(e3.participant), t = r.useMemo(() => ls(n), [n]);
...
function Dt2({
  ...
  const s = Ws(e3), c = r.useMemo(() => {
    ...
    publication: o
  }), [o, s.participant]), i2 = z(s), d = z(u), l = Ye2(s.participant), f = Xe2(s);
  return {
    elementProps: {
      "data-lk-audio-muted": d,
      "data-lk-video-muted": i2,
      "data-lk-speaking": t === true ? false : l,
...
function $(e3 = {}) {
  const n = zs(e3.room), [t, a] = r.useState([]);
  return r.useEffect(() => {
    const s = cs(n, {
...
function Lt2(e3 = {}) {
  const n = $(e3), { localParticipant: t } = Ze2(e3);
  return r.useMemo(
    () => [t, ...n],
    [t, n]
  );
...
function Ft2(e3, n = {}) {
  const t = Hs(), [a] = r.useState(n.updateOnlyOn), s = r.useMemo(() => typeof e3 == "string" ? us(t, e3, {
    additionalEvents: a
  }) : fs(t, e3, {
    additionalEvents: a
  }), [t, JSON.stringify(e3), a]), [c, o] = r.useState({
    p: void 0
  });
  return r.useEffect(() => {
...
function Nt2(e3 = {}) {
  const n = zs(e3.room), t = r.useMemo(() => ns(n), [n]), { name: a, metadata: s } = b(t, {
    name: n.name,
    metadata: n.metadata
  });
...
function et2() {
  const e3 = Hs(), n = r.useMemo(() => rs(e3), [e3]);
...
function Bt2({ room: e3, props: n }) {
  const t = zs(e3), { className: a, roomAudioPlaybackAllowedObservable: s, handleStartAudioPlayback: c } = r.useMemo(
    () => Ss(),
    []
  ), o = r.useMemo(
    () => s(t),
...
function zt2({ room: e3, props: n }) {
  const t = zs(e3), { className: a, roomVideoPlaybackAllowedObservable: s, handleStartVideoPlayback: c } = r.useMemo(
    () => Es(),
    []
  ), o = r.useMemo(
    () => s(t),
...
function Ut2(e3, n = {}) {
  const t = r.useRef(null), a = r.useRef(null), s = n.minSwipeDistance ?? 50, c = (i2) => {
    a.current = null, t.current = i2.targetTouches[0].clientX;
  }, o = (i2) => {
    a.current = i2.targetTouches[0].clientX;
  }, u = r.useCallback(() => {
    if (!t.current || !a.current)
      return;
    const i2 = t.current - a.current, d = i2 > s, l = i2 < -s;
...
function qt2({ props: e3 }) {
  const { dispatch: n, state: t } = $s().widget, { className: a } = r.useMemo(() => Ts(), []);
...
function Jt2(e3, n, t = {}) {
  ...
  return r.useEffect(() => {
    ...
    (async () => {
      ...
      const u = new URLSearchParams({ ...t.userInfo, roomName: n }), i2 = await fetch(`${e3}?${u.toString()}`);
      if (!i2.ok) {
        _2.error(
  ...
  }, [e3, n, JSON.stringify(t)]), a;
}
function xt2(e3) {
  var c, o;
  const n = Ws(e3), { className: t, mediaMutedObserver: a } = r.useMemo(
    () => gs(n),
    [N(n)]
  );
  return { isMuted: b(
...
function _t2({
  ...
  var P;
  const u = Io(), i2 = (P = u == null ? void 0 : u.localParticipant) == null ? void 0 : P.getTrackPublication(e3), d = r.useRef(false), { toggle: l, className: f, pendingObserver: p, enabledObserver: g } = r.useMemo(
    () => u ? ps(e3, u, a, s, c) : hs(),
    [u, e3, JSON.stringify(a), s]
  ), S = b(p, false), m = b(g, t ?? !!(i2 != null && i2.isEnabled));
  r.useEffect(() => {
    n == null || n(m, d.current), d.current = false;
  }, [m, n]), r.useEffect(() => {
    t !== void 0 && (_2.debug("forcing initial toggle state", e3, t), l(t));
  }, []);
  const M3 = r.useMemo(() => M2(o, { className: f }), [o, f]), v = r.useCallback(
    (h) => {
      var I2;
      d.current = true, l().catch(() => d.current = false), (I2 = o.onClick) == null || I2.call(o, h);
    },
    [o, l]
  );
  return {
...
function Wt2(e3 = [
  ...
  const t = zs(n.room), [a, s] = r.useState([]), [c, o] = r.useState([]), u = r.useMemo(() => e3.map((d) => Gi(d) ? d.source : d), [JSON.stringify(e3)]);
  return r.useEffect(() => {
    const d = As(t, u, {
      additionalRoomEvents: n.updateOnlyOn,
      onlySubscribed: n.onlySubscribed
    }).subscribe(({ trackReferences: l, participants: f }) => {
      _2.debug("setting track bundles", l, f), s(l), o(f);
    });
    return () => d.unsubscribe();
  }, [
    t,
    ...
    if (Qo(e3)) {
      const d = nt2(e3, c), l = Array.from(a);
      return c.forEach((f) => {
        d.has(f.identity) && (d.get(f.identity) ?? []).forEach((g) => {
          if (a.find(
            ({ participant: m, publication: M3 }) => f.identity === m.identity && M3.source === g
          ))
            return;
          _2.debug(
...
function st2(e3) {
  const [n, t] = r.useState(Bt(e3)), { trackObserver: a } = r.useMemo(() => es(e3), [e3.participant.sid ?? e3.participant.identity, e3.source]);
  return r.useEffect(() => {
...
function Qt2(e3, n) {
  const t = Vs(n);
  return st2({ name: e3, participant: t });
}
function $t2(e3) {
  const n = Hs(), t = O2(n), a = r.useMemo(
...
function Gt2(e3 = {}) {
  const [n, t] = r.useState(
    ...
    t((d) => ({ ...d, audioEnabled: i2 }));
  }, []), s = r.useCallback((i2) => {
    t((d) => ({ ...d, videoEnabled: i2 }));
  }, []), c = r.useCallback((i2) => {
    t((d) => ({ ...d, audioDeviceId: i2 }));
  }, []), o = r.useCallback((i2) => {
    t((d) => ({ ...d, videoDeviceId: i2 }));
  }, []), u = r.useCallback((i2) => {
    t((d) => ({ ...d, username: i2 }));
  }, []);
  return r.useEffect(() => {
    Ms(n, e3.preventSave ?? false);
  }, [n, e3.preventSave]), {
    userChoices: n,
...
function Ht2(e3, n = {}) {
  const t = Vs(e3), a = zs(n.room), s = r.useMemo(() => os(a, t), [a, t]);
  return b(
    s,
...
function jt2(e3, n = { fftSize: 32, smoothingTimeConstant: 0 }) {
  const t = W(e3) ? e3.publication.track : e3, [a, s] = r.useState(0);
  return r.useEffect(() => {
    if (!t || !t.mediaStream)
      return;
    const { cleanup: c, analyser: o } = createAudioAnalyser(t, n), u = o.frequencyBinCount, i2 = new Uint8Array(u), l = setInterval(() => {
...
function Xt2(e3, n = {}) {
  var o;
  const t = e3 instanceof Track ? e3 : (o = e3 == null ? void 0 : e3.publication) == null ? void 0 : o.track, a = { ...rt2, ...n }, [s, c] = r.useState(
    new Array(a.bands).fill(0)
  );
  return r.useEffect(() => {
    if (!t || !(t != null && t.mediaStream))
      return;
    const { analyser: u, cleanup: i2 } = createAudioAnalyser(t, a.analyserOptions), d = u.frequencyBinCount, l = new Float32Array(d), p = setInterval(() => {
      u.getFloatFrequencyData(l);
      let g = new Float32Array(l.length);
      for (let v = 0; v < l.length; v++)
        g[v] = l[v];
      g = g.slice(n.loPass, n.hiPass);
      const S = at2(g), m = Math.ceil(S.length / a.bands), M3 = [];
      for (let v = 0; v < a.bands; v++) {
        const P = S.slice(v * m, (v + 1) * m).reduce((h, I2) => h += I2, 0);
        M3.push(P / m);
      }
      c(M3);
    }, a.updateInterval);
...
function Yt(e3, n = {}) {
  var l;
  const t = e3 instanceof Track ? e3 : (l = e3 == null ? void 0 : e3.publication) == null ? void 0 : l.track, a = { ...ct2, ...n }, s = r.useRef(new Float32Array()), c = r.useRef(performance.now()), o = r.useRef(0), [u, i2] = r.useState([]), d = r.useCallback((f) => {
    i2(
      Array.from(
        it2(f, a.barCount).map((p) => Math.sqrt(p) * a.volMultiplier)
  ...
  return r.useEffect(() => {
    ...
    }), g = U2(a.barCount), S = new Float32Array(g), m = () => {
      if (M3 = requestAnimationFrame(m), f.getFloatTimeDomainData(S), s.current.map((v, P) => v + S[P]), o.current += 1, performance.now() - c.current >= a.updateInterval) {
        const v = S.map((P) => P / o.current);
        d(v), c.current = performance.now(), o.current = 0;
      }
    };
    let M3 = requestAnimationFrame(m);
    return () => {
      p(), cancelAnimationFrame(M3);
    };
...
function it2(e3, n) {
  const t = Math.floor(e3.length / n), a = new Float32Array(n);
  for (let s = 0; s < n; s++) {
    const c = t * s;
    let o = 0;
    for (let u = 0; u < t; u++)
...
function ut2(e3, n) {
  const t = Hs(), a = _o(), s = n ? t.getParticipantByIdentity(n) : a, c = r.useMemo(
...
function ft2(e3, n) {
  const t = { ...lt2, ...n }, [a, s] = r.useState([]), c = dt2(e3), o = (u) => {
    var i2;
    (i2 = t.onTranscription) == null || i2.call(t, u), s(
      (d) => Go(
        d,
...
function pt2(e3 = {}) {
  const n = _o(), t = e3.participant ?? n, a = r.useMemo(
...
function Zt2(e3, n = {}) {
  const t = Vs(n.participant), [a, s] = r.useState(t.attributes[e3]);
  return r.useEffect(() => {
    if (!t)
      return;
    const c = ds(t).subscribe((o) => {
...
var q3 = "lk.agent.state";
function Kt2() {
  const e3 = $().find((o) => o.kind === ParticipantInfo_Kind.AGENT), n = ut2([Track.Source.Microphone], e3 == null ? void 0 : e3.identity)[0], { segments: t } = ft2(n), a = O2(), { attributes: s } = pt2({ participant: e3 }), c = r.useMemo(() => a === ConnectionState.Disconnected ? "disconnected" : a === ConnectionState.Connecting || !e3 || !(s != null && s[q3]) ? "connecting" : s[q3], [s, e3, a]);
  return {
    agent: e3,
    state: c,
    audioTrack: n,
...
function en2(e3) {
  const n = zs(e3), t = O2(n), a = r.useMemo(() => ss(n), [n, t]);
  return b(a, n.isRecording);
}
function tn2(e3) {
  const n = Hs(), a = O2(n) === ConnectionState.Disconnected, s = r.useMemo(() => Ds(n, e3), [n, e3]);
...
// node_modules/@livekit/components-react/dist/components-01Mw9Q_q.mjs
...
function ye2(t, n) {
  switch (t) {
    ...
    case Track.Source.Camera:
      return n ? e.createElement(vt3, null) : e.createElement(gt2, null);
    case Track.Source.ScreenShare:
...
var fa = e.forwardRef(function({ showIcon: n, ...a }, r2) {
  const { buttonProps: c, enabled: s } = _t2(a), [o, l] = e.useState(false);
  return e.useEffect(() => {
    l(true);
...
var Se2 = e.forwardRef(
  function({ trackRef: n, show: a = "always", ...r2 }, c) {
    const { className: s, isMuted: o } = xt2(n), l = a === "always" || a === "muted" && o || a === "unmuted" && !o, i2 = e.useMemo(
      () => B2(r2, {
        className: s
      }),
      [s, r2]
...
function Tt3() {
  ...
  function v(h, E, k2) {
    ...
    function U3(R) {
      var x = I2, H3 = V2;
      return I2 = V2 = void 0, F2 = R, N2 = h.apply(H3, x), N2;
    }
    function Pe2(R) {
      return F2 = R, M3 = setTimeout(W3, E), re2 ? U3(R) : N2;
    }
    function Te2(R) {
      var x = R - P, H3 = R - F2, se2 = E - x;
      return Z2 ? p(se2, O4 - H3) : se2;
    }
    function ce2(R) {
      var x = R - P, H3 = R - F2;
      return P === void 0 || x >= E || x < 0 || Z2 && H3 >= O4;
    }
    function W3() {
      var R = m();
      if (ce2(R))
...
function Ea({ tracks: t, orientation: n, ...a }) {
  const r2 = e.useRef(null), [c, s] = e.useState(0), { width: o, height: l } = je2(r2), i2 = n || (l >= o ? "vertical" : "horizontal"), u = i2 === "vertical" ? Math.max(o * qt3, Ot3) : Math.max(l * xe, Wt3), d = Fo(), g = Math.max(i2 === "vertical" ? (l - d) / u : (o - d) / u, me2);
  let f = Math.round(g);
...
function ee2({
  ...
  const p = e2.useRef(null), m = e2.useRef(null), u = e2.useMemo(() => ({ messageDecoder: d, messageEncoder: l, channelTopic: n }), [d, l, n]), { chatMessages: s, send: I2, isSending: t } = $t2(u), h = Lo(), r2 = e2.useRef(0);
  async function v(c) {
...
function et3({
  ...
  const {
    ...
    preventSave: !I2,
    preventLoad: !I2
  }), [a, C] = e2.useState(r2), [S, A3] = e2.useState(a.audioEnabled), [w, L3] = e2.useState(a.videoEnabled), [T2, $2] = e2.useState(a.audioDeviceId), [k2, N2] = e2.useState(a.videoDeviceId), [V2, ae2] = e2.useState(a.username);
  e2.useEffect(() => {
    c(S);
  }, [S, c]), e2.useEffect(() => {
    i2(w);
  ...
  const [se2, ce2] = e2.useState(), _4 = e2.useCallback(
  ...
  function re2(b2) {
    b2.preventDefault(), _4(a) ? typeof l == "function" && l(a) : _2.warn("Validation failed with: ", a);
  }
  return W2(), e2.createElement("div", { className: "lk-prejoin", ...h }, e2.createElement("div", { className: "lk-video-container" }, M3 && e2.createElement("video", { ref: U3, width: "1280", height: "720", "data-lk-facing-mode": ne2 }), (!M3 || !w) && e2.createElement("div", { className: "lk-camera-off-note" }, e2.createElement(Pt3, null))), e2.createElement("div", { className: "lk-button-group-container" }, e2.createElement("div", { className: "lk-button-group audio" }, e2.createElement(
    ...
    O3,
    {
      ...
      onActiveDeviceChange: (b2, F2) => $2(F2)
    }
...
var Je2 = e2.forwardRef(
  function(d, l) {
    const { mergedProps: n } = Ge3({ props: d });
...
function te({
  ...
  const I2 = St(`(max-width: ${p ? 1e3 : 760}px)`) ? "minimal" : "verbose";
  o ?? (o = I2);
  ...
  } = Gt2({ preventSave: !l }), L3 = e2.useCallback(
    (k2, N2) => N2 ? C(k2) : null,
    [C]
  ), T2 = e2.useCallback(
    (k2, N2) => N2 ? S(k2) : null,
...
function nt3({
  ...
  const E = { leave: true, microphone: true, ...o }, p = Tt2(), { microphoneTrack: m, localParticipant: u } = Ze2(), s = e2.useMemo(() => ({
    participant: u,
    source: Track.Source.Microphone,
    publication: m
  }), [u, m]);
  p ? E.microphone ?? (E.microphone = p.canPublish) : E.microphone = false;
  const I2 = B2({ className: "lk-agent-control-bar" }, n), { saveAudioInputEnabled: t, saveAudioInputDeviceId: h } = Gt2({
    preventSave: !d
  }), r2 = e2.useCallback(
    (v, c) => {
      c && t(v);
...
export {
  ...
  Ye2 as useIsSpeaking,
  $s as useLayoutContext,
  q2 as useLiveKitRoom,
  Ze2 as useLocalParticipant,
  ...
  Ft2 as useRemoteParticipant,
  $ as useRemoteParticipants,
  Hs as useRoomContext,
  Nt2 as useRoomInfo,
  Vt2 as useSortedParticipants,
  et2 as useSpeakingParticipants,
